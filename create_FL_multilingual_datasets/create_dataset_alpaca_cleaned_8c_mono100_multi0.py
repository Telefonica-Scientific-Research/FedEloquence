...
files = ["en.jsonl", "es.jsonl", "de.jsonl", "ca.jsonl", "da.jsonl", "sr.jsonl", "hr.jsonl", "eu.jsonl"]
...
with open('./data/alpaca_cleaned_8c_mono100_multi0.jsonl', 'w') as output_file:
    for entry in new_data:
        output_file.write(json.dumps(entry) + '\n')

print("New JSONL file created with the concatenated data from all languages and the correct distribution for the server and independent clients.")
print("Dataset saved to 'data/alpaca_cleaned_8c_mono100_multi0.jsonl'")